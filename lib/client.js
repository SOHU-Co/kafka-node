...
Client.prototype.handleReceivedData = function (socket) {
        ...
        if (socket.buffer.length >= size) {
            ...
            // ProduceResponse decoder returns the results in a format different than the other decoders (wrapped in a 'response' object to differentiate it from other decoders).
