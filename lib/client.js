...
Client.prototype.sendVersionsRequest = function (cb) {
  logger.debug('send versions request');
  ...
  this.queueCallback(broker.socket, correlationId, [protocol.decodeVersionsResponse, cb]);
