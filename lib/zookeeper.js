...
var Zookeeper = function (connectionString, options) {
    if (typeof options != 'undefined' && typeof options.pathPrefix != 'undefined') {
...
Zookeeper.prototype.registerConsumer = function (groupId, consumerId, payloads, cb) {
    var path = this.pathPrefix + '/consumers/' + groupId;
    var that = this;
...
Zookeeper.prototype.listBrokers = function (cb) {
    var that = this;
    var path = this.pathPrefix + '/brokers/ids';
    this.client.getChildren(
        ...
        function (error, children) {
            ...
            function getBrokerDetail (id, cb) {
                var path = that.pathPrefix + '/brokers/ids/' + id;
...
Zookeeper.prototype.listConsumers = function (groupId) {
    var that = this;
    var path = this.pathPrefix + '/consumers/' + groupId + '/ids';
    this.client.getChildren(
        path,
        function () {
            if (!that.closed) {
...
Zookeeper.prototype.topicExists = function (topic, cb, watch) {
    var path = this.pathPrefix + '/brokers/topics/' + topic,
        self = this;
    this.client.exists(
        path,
        function (event) {
...
Zookeeper.prototype.deletePartitionOwnership = function (groupId, topic, partition, cb) {
    var path = this.pathPrefix + '/consumers/' + groupId + '/owners/' + topic + '/' + partition,
        self = this;
    this.client.remove(
        path,
        function (error) {
...
Zookeeper.prototype.addPartitionOwnership = function (consumerId, groupId, topic, partition, cb) {
    ...
    async.series([
            function (callback) {
                self.client.create(
                        self.pathPrefix + '/consumers/' + groupId,
                    function (error, path) {
                        // simply carry on
                        callback();
                    });
            ...
            function (callback) {
                self.client.create(
                        self.pathPrefix + '/consumers/' + groupId + '/owners',
                    function (error, path) {
                        // simply carry on
                        callback();
                    });
            ...
            function (callback) {
                self.client.create(
                        self.pathPrefix + '/consumers/' + groupId + '/owners/' + topic,
                    function (error, path) {
                        // simply carry on
                        callback();
                    });
