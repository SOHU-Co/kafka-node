...
Consumer.prototype.fetch = function () {
    ...
    if (this.paused) {
        ...
        var empty_payloads = this.payloads.map(function (j) {
        ...
        this.client.sendFetchRequest(this, this.payloads, this.options.fetchMaxWaitMs, this.options.fetchMinBytes, this.options.maxTickMessages);
    }
};
