...
function encodeOffsetCommitV2Request (group, generationId, memberId) {
  return function (clientId, correlationId, payloads) {
    return _encodeOffsetCommitV2Request(clientId, correlationId, group, generationId, memberId, payloads);
  };
}

function _encodeOffsetCommitV2Request (clientId, correlationId, group, generationId, memberId, payloads) {
  payloads = groupByTopic(payloads);
