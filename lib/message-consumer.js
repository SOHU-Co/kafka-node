...
function MessageConsumer (client, initialTopics, options) {
    ...
    options = _.extend({}, options, { autoCommit: false }); // XXX fix
    this.ephemerals = {};
    ...
    this.lastReceivedOffset = {};
    this.lastCommittedOffset = {};
    this.messageByOffset = {};
        ...
        function emitMessage(key, offset) {
            ...
            self.emit('message', message, function () {
                ...
                self.commit(message, function (err) {
                    ...
                    console.log('======', self.lastCommittedOffset[key], '<', offset, '<=', self.lastReceivedOffset[key]);
